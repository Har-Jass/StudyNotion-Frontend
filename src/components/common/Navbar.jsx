...
//         link: "/catalogue/web-development"
//     }
// ];
  ...
  return (
    <div className={`flex h-14 items-center justify-center border-b-[1px] border-b-richblack-700 ${location.pathname !== "/" ? "bg-richblack-800" : ""} transition-all duration-200`}>
        <div className='flex w-11/12 max-w-maxContent items-center justify-between'>
            {/* adding Logo of StudyNotion in Navigation Bar */}
            <Link to="/">
                            ...
                            <li key={index}>
                                {
                                    ...
                                    (
                                        <>
                                            <div className={`group relative flex cursor-pointer items-center gap-1 ${matchRoute("/catalogue/:catalogueName") ? "text-yellow-25" : "text-richblack-25"}`}>
                                                <p>
                                                    {link.title}
                                                </p>
